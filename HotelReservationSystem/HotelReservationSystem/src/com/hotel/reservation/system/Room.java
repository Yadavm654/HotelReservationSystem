...
public class Room extends Person
{
    ...
    public void roomRegistration(int pid) 
    {
    ...
    public void ShowRoomDetails(int id)
    {
    	try {
    		...
    		while(rs.next())
    		{ 
    			System.out.println("RoomD:      "+rs.getInt(1));
    ...
    public void Givefeedback(int id) 
    {
    	...
    	System.out.println("Nature Of The Customer");
